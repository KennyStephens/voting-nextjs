      ...
      <div className="bg-white">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
            <Image
              src="/images/product/product-feature-03-detail-01.jpg"
            ...
            />
            <Image
              src="/images/product/product-feature-03-detail-02.jpg"
            ...
            />
            <Image
              src="/images/product/product-feature-03-detail-03.jpg"
            ...
            />
            <Image
              src="/images/product/product-feature-03-detail-04.jpg"
